...
class AudioProvider extends ChangeNotifier {
  ...
  Stream<Duration> _playerPositionStream =Stream<Duration>.value( Duration.zero).asBroadcastStream();
  Duration _duration = Duration.zero;
  late AudioSource _playlist;
  bool get isPlaying => _isPlaying;
  Duration get playerPosition => _playerPosition;
  Duration get duration => _duration;
  Stream<Duration> get playerPositionStream  => _playerPositionStream;
  void set playerPosition(Duration duration) {
  ...
  Future<void> listenToPlayState() async {
    _playerPositionStream = _audioPLayer.positionStream.asBroadcastStream();
