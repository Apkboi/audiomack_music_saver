...
// Define the playlist
  ...
  Widget build(BuildContext context) {
    final value = context.read<AudioProvider>();
    // currentPosition = value.playerPosition.inMicroseconds;
    StreamSubscription positionSubscription = value.playerPositionStream.listen((event) {
     setState(() {
       currentPosition = event.inMicroseconds;
     });
    });
    return SafeArea(
      child: Scaffold(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SfSlider(
                    ...
                    onChanged: (val) {
                      setState(() {
                        currentPosition = val.toInt();
                        // value.playerPosition = Duration(microseconds: val.toInt());
                      });
                      // setState(() {
                      //   currentPosition = (val as double).toInt();
                      // });
                    },
                    onChangeEnd: (val) {
                      positionSubscription.resume();
                      value.seek(Duration(microseconds: val.toInt()));
